...
void Radar::RenderSettingsPreview(float panelLeft, float panelTop, float panelRight, float panelBottom,
                                  float screenW, float screenH, RadarConfig::RadarCamContext camCtx)
{
    ...
    m_pRenderer->RenderSettingsPreview(panelLeft, panelTop, panelRight, panelBottom, screenW, screenH, camCtx);
}
