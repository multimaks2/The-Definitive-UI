...
public:
    ...
    void Shutdown();
    void Render();
    void RenderSettingsPreview(float panelLeft, float panelTop, float panelRight, float panelBottom,
    ...
    LPDIRECT3DTEXTURE9 GetBlipRenderTargetTexture() const;
...
private:
    ...
    void RenderBlipRenderTarget(float circleX, float circleY, float sizeX, float sizeY, bool previewPedOnly = false);
    ...
    RenderTarget*        m_pBlipRenderTarget;
