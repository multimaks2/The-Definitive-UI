 ...
 *  FILE:        source/PauseMenu/PauseMenu.h
...
public:
    ...
    struct Layout
    {
        ...
        // Right panel (Stats) — same anchor as MainMenu embedded panels @2K
        ...
        static constexpr float PanelTopY     = 55.0f;
        static constexpr float PanelListTopY = 148.0f;
        static constexpr float PanelH        = 1000.0f;
        static constexpr float PanelPadX     = 36.0f;
        static constexpr DWORD PanelZebraA   = 0xC8000000;
        static constexpr DWORD PanelZebraB   = 0xFF000000;
        static constexpr DWORD StatsValueCol = 0xFFFFE8A8;

        // Stats
        static constexpr float StatsRowH     = 54.0f;
        static constexpr float StatsFont     = 28.0f;
        static constexpr float StatsRankFont = 30.0f;
        static constexpr float StatsCatArrowSz = 20.0f;
        static constexpr int   StatsCategoryCount = 8;
...
private:
    ...
    ButtonRect GetContentPanelRect(float screenW, float screenH) const;
    bool IsStatsOpen() const { return m_nActive == static_cast<int>(Button::Stats); }
    void DrawStatsPanel(float screenW, float screenH);
    void HandleStatsInput(float screenW, float screenH);
    void ResetStatsView();
    ...
    int                m_nStatsCategory = 0;
    float              m_fStatsScroll = 0.0f;
};
